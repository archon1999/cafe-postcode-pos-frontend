...
import { canAccessCashier, canAccessWaiter, getPosHomePath, isHallMode, usePosSession } from 'modules/auth';
import {
...
function TableSessionPageContent({ sessionId, mode }: { sessionId: string | null; mode: 'hall' | 'takeaway' }) {
